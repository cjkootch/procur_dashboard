...
export function AssistantDrawer() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 right-4 flex h-[min(80vh,720px)] w-[min(95vw,560px)] flex-col overflow-hidden rounded-[var(--radius-lg)] border border-[color:var(--color-border)] bg-[color:var(--color-background)] shadow-2xl">
