...
/**
 * Per docs/vex-into-procur-merge-brief.md Phase 5. Per-deal cost
 * build-up. Kept off `fuel_deals` so the deal record stays compact
 * and scenarios can copy + override the cost stack independently.
 * Summary columns are persisted by the calculator; they are NOT the
 * source of truth — the active scenario's `results_json` is.
 */
export const fuelDealCostStack = pgTable(
  'fuel_deal_cost_stack',
  {
    ...
    freightBasis: freightBasisEnum('freight_basis')
      .notNull()
      .default('per_usg'),
    freightRateRaw: doublePrecision('freight_rate_raw').notNull().default(0),
    freightRatePerUsg: doublePrecision('freight_rate_per_usg')
      .notNull()
      .default(0),
    freightCurrency: dealCurrencyEnum('freight_currency')
      .notNull()
      .default('usd'),
    ...
    freightPerUsgAllIn: doublePrecision('freight_per_usg_all_in')
      .notNull()
      .default(0),

    cargoInsurancePct: doublePrecision('cargo_insurance_pct')
      .notNull()
      .default(0),
    cargoInsuranceUsd: doublePrecision('cargo_insurance_usd')
      .notNull()
      .default(0),
    ...
    totalInsurancePerUsg: doublePrecision('total_insurance_per_usg')
      .notNull()
      .default(0),
    ...
    totalCompliancePerUsg: doublePrecision('total_compliance_per_usg')
      .notNull()
      .default(0),
    ...
    tradeFinanceTotalUsd: doublePrecision('trade_finance_total_usd')
      .notNull()
      .default(0),
    tradeFinancePerUsg: doublePrecision('trade_finance_per_usg')
      .notNull()
      .default(0),
    ...
    totalAgentPerUsg: doublePrecision('total_agent_per_usg')
      .notNull()
      .default(0),

    vtcVariableOpsPerUsg: doublePrecision('vtc_variable_ops_per_usg')
      .notNull()
      .default(0),

    overheadAllocationUsd: doublePrecision('overhead_allocation_usd')
      .notNull()
      .default(0),
    overheadPerUsg: doublePrecision('overhead_per_usg').notNull().default(0),

    totalLandedCostPerUsg: doublePrecision('total_landed_cost_per_usg')
      .notNull()
      .default(0),
    grossMarginPerUsg: doublePrecision('gross_margin_per_usg')
      .notNull()
      .default(0),
    grossMarginPct: doublePrecision('gross_margin_pct').notNull().default(0),
    netMarginPerUsg: doublePrecision('net_margin_per_usg')
      .notNull()
      .default(0),
    netMarginPct: doublePrecision('net_margin_pct').notNull().default(0),
    ebitdaUsd: doublePrecision('ebitda_usd').notNull().default(0),
    breakevenSellPriceUsg: doublePrecision('breakeven_sell_price_usg')
      .notNull()
      .default(0),
