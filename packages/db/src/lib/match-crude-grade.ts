...
const ASSAY_NAME_ALIASES: Record<string, string> = {
  ...
  // ── North Sea (Brent BFOET co-markers + adjacent fields) ────
  'forties': 'forties-blend',
  'forties bl': 'forties-blend',
  'forties blend': 'forties-blend',
  'ekofisk': 'ekofisk',
  'oseberg': 'oseberg',
  'troll': 'troll',
  'troll blend': 'troll',
  ...
  'hungo blend': 'hungo',
  'kissanje': 'kissanje',
  'kissanje blend': 'kissanje',
  'saturno': 'saturno',
  'saturno blend': 'saturno',
  'saxi batuque': 'saxi-batuque',
  'saxi batuque blend': 'saxi-batuque',
  'saxi blend': 'saxi-batuque',
  'saxi-batuque': 'saxi-batuque',
  'saxi_batuque': 'saxi-batuque',
  'gindungo': 'gindungo',
  'mostarda': 'mostarda',
  'nemba': 'nemba',
  'nkossa blend': 'nkossa-blend',
  'nkossa-blend': 'nkossa-blend',
  'djeno': 'djeno',
  'mandji': 'mandji',
  ...
  'peregrino': 'peregrino',
  'roncador': 'roncador',
  'roncador 20': 'roncador',
  'roncador 28': 'roncador',

  // ── US GoM / onshore ───────────────────────────────────────
  'mars': 'mars-blend',
  'mars blend': 'mars-blend',
  'thunder horse': 'thunder-horse',
  'thunder-horse': 'thunder-horse',
  'thunder_horse': 'thunder-horse',
  'southern green canyon': 'southern-green-canyon',
  'southern-green-canyon': 'southern-green-canyon',
  'bakken': 'bakken',
  ...
  'domestic_sweet': 'domestic-sweet',

  // ── Canada heavies ─────────────────────────────────────────
  'cold lake blend': 'cold-lake-blend',
  'cold_lake_blend': 'cold-lake-blend',
  'cold-lake-blend': 'cold-lake-blend',
  'kearl': 'kearl',
  'fort hills reduced carbon life cycle dilbit': 'fort-hills-dilbit',
  'fort-hills-reduced-carbon-life-cycle-dilbit': 'fort-hills-dilbit',
  'synbit shb': 'synbit',
  'synbit-shb': 'synbit',
  ...
  'handil-mix': 'handil-mix',
  'gippsland': 'gippsland',
  'gippsland condensate': 'gippsland',
  'gorgon': 'gorgon',
  'north west shelf condensate': 'north-west-shelf-condensate',
  'north-west-shelf-condensate': 'north-west-shelf-condensate',
  'cossack': 'cossack',
  'kutubu': 'kutubu',
  'banyu urip': 'banyu-urip',
  'banyu_urip': 'banyu-urip',
